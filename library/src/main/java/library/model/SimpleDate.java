...
public class SimpleDate implements java.io.Serializable {
  ...
  /** Create a new date that represents a date one month after the
   *  date to which it is applied.  (If the day of the month of this
   *  SimpleDate is impossible for the next month [ e.g. it's 31 and
   *  the next month is a 30 day month ], the day of the month is
   *  set to the largest possible value in the new month.)
   *
