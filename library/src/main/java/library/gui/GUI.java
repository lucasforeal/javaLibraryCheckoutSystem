...
public class GUI extends javax.swing.JFrame {
  ...
  private void loginItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginItemActionPerformed
    ...
    if (password != null)
      try
      {
        ...
        LoginOut.getInstance().doLogin(password);
        if (LoginOut.getInstance().isManagerLoggedIn())
        {
  ...
  private GUI() {
      ...
      getContentPane().add(new CopyDetailsCard(), "copydetails");
